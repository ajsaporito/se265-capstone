                ...
                <?php foreach ($completedJobs as $job): ?>
                  <div class="card mb-4 job-card">
                    <div class="card-body d-flex justify-content-between align-items-center">
                      ...
                      <?php if (isset($job['reviews']) && count($job['reviews']) === 0): ?>
                        <!-- Show the Leave a Review button if no reviews exist -->
                        <a id="review-btn" class="btn btn-success" href="/se265-capstone/add-review?id=<?= htmlspecialchars($job['contractor_id']); ?>&job_id=<?= htmlspecialchars($job['job_id']); ?>">Leave a Review</a>
                      <?php else: ?>
                        <!-- Show a message if the review exists -->
